...
Ext.define('CULINARIA.controller.BaseController', {
    ...
    showWindows: function () {
        Ext.create('CULINARIA.view.'+this.modelName.toLowerCase()+'.'+this.modelName+'Form',{autoShow:true,btnText:'Salvar',title:'Adicionar '+this.modelName.toLowerCase()+''});
    },
    ...
    {
        var win = Ext.create('CULINARIA.view.'+this.modelName.toLowerCase()+'.'+this.modelName+'Form',{btnText:'Editar',title:'Editar '+this.modelName.toLowerCase()+''});
